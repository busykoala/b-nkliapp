...
vi.mock("./evidence", () => ({ evaluateRoute: () => ({ quiet: 1, nature: .8, view: null, water: null, light: null, coverage: 1, lightCoverage: 0, sources: ["OpenStreetMap"], reasons: [message("walks.evidence.quiet")], warnings: [], updatedAt: null }) }));
