...
export type RouteNoise = { mode: "road" | "rail"; period: "day" | "night"; meanDb: number | null; coverage: number; datasetVersions: string[] };
export type RouteEvidence = { noise?: RouteNoise[]; quiet: number | null; nature: number | null; view: number | null; water: number | null; light: number | null; lightCoverage: number; coverage: number; updatedAt: string | null; sources: string[]; reasons: UiMessage[]; warnings: UiMessage[] };
