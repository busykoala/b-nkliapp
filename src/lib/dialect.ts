...
const regionMeta: Record<DialectRegion, LocalBenchProfile & { phrases: string[] }> = {
  ...
  zurich: { region: "zurich", regionLabel: "Züridütsch", languageTag: "gsw-CH", uiLanguage: "de", phrases: ["Da chasch di grad anesetze, zum es bitzli verschnuufe.", "Züri isch busy. Das Bänkli demonstriert dezue konsequents Nütmache."] },
