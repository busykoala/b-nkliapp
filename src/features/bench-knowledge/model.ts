...
export type BenchKnowledge = {
  ...
  amenities: Array<{ category: string; distanceMeters: number | null; sourceId: string | null; latitude: number | null; longitude: number | null; count100m: number | null; count250m: number | null; count500m: number | null; distanceType?: "straight_line"; computedAt?: string; sourceVersion?: string | null; coverage?: "recorded" | "unknown" }>;
