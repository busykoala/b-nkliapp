...
const querySchema = z.object({ benchId: z.string().max(90), origin, mode: z.enum(["walk", "transit"]), time: z.iso.datetime({ offset: true }), arriveBy: z.boolean(), speedKmh: z.union([z.literal(3), z.literal(4.2), z.literal(5.4)]), bufferMinutes: z.union([z.literal(0), z.literal(3), z.literal(6), z.literal(10)]) });
