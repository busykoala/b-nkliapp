...
| Road and railway noise | [BAFU sonBASE](https://www.bafu.admin.ch/de/sonbase), official `ch.bafu.laerm-strassenlaerm_tag`, `_nacht`, `ch.bafu.laerm-bahnlaerm_tag`, `_nacht` single-band LV95 rasters. Point sample with scale/offset, masked NoData, ETag/Last-Modified version. Road-day reuses the existing landscape raster. | `bench_noise_exposure`: four separate channels in `dB(A) Lr`, `sonbase-point-1`. Day 06–22, night 22–06. Modelled assessment levels, not live measurements or an unexplained combined quietness score. |
