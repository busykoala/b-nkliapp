...
def audit_environment(connection: sqlite3.Connection, *, release_smoke: bool = False) -> dict[str, object]:
    ...
    return {
        ...
        "current_sun_models": scalar("""SELECT count(*) FROM bench_enrichments
          WHERE pipeline_version IN ('4.2.0','4.3.0','4.4.0','4.5.0','GeoAdmin-Horizont v4','GeoAdmin-Horizont v5','GeoAdmin-Horizont v6','GeoAdmin-Horizont v7') AND json_array_length(horizon_profile)=72"""),
